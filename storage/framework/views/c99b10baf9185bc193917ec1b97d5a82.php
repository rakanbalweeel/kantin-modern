...
<div class="min-h-screen hero-gradient py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex items-center mb-4 md:mb-0">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white">Laporan <span class="gradient-text">Penjualan</span></h1>
                        <p class="text-slate-400 mt-1">Analisis penjualan sistem kantin</p>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    <button onclick="window.print()" class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-xl shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 transition-all print:hidden">
                        <i class="fas fa-print mr-2"></i> Cetak
                    </button>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 glass rounded-xl text-slate-300 hover:text-orange-400 transition-all print:hidden">
        ...
        <div class="glass-card rounded-2xl p-6 mb-8 print:hidden">
            <form action="<?php echo e(route('admin.reports.sales')); ?>" method="GET" class="flex flex-wrap items-end gap-4">
                ...
                <a href="<?php echo e(route('admin.reports.sales')); ?>" class="px-6 py-2.5 bg-slate-700 text-slate-300 rounded-xl hover:bg-slate-600 transition-all">
                    Reset
                </a>
            </form>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-emerald-400">
                    Rp <?php echo e(number_format($totalSales ?? 0, 0, ',', '.')); ?>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-blue-400">
                    <?php echo e($totalTransactions ?? 0); ?>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-sm font-medium text-slate-400 mb-1">Total Pajak</p>
                <p class="text-2xl font-extrabold text-purple-400">
                    Rp <?php echo e(number_format($totalTax ?? 0, 0, ',', '.')); ?>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-orange-400">
                    Rp <?php echo e(number_format($averageTransaction ?? 0, 0, ',', '.')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <div class="p-4 flex items-center justify-between hover:bg-white/5 transition-colors">
                            <div class="flex items-center">
                                <span class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3
                                    <?php echo e($index === 0 ? 'bg-yellow-500/20 text-yellow-400' : ($index === 1 ? 'bg-slate-500/20 text-slate-300' : ($index === 2 ? 'bg-amber-500/20 text-amber-400' : 'bg-slate-700 text-slate-400'))); ?>">
                                    <?php echo e($index + 1); ?>

                                </span>
                                <div>
                                    <p class="font-semibold text-white"><?php echo e($product->nama); ?></p>
                                    <p class="text-sm text-slate-500"><?php echo e($product->total_sold); ?> terjual</p>
                                </div>
                            </div>
                            <p class="font-bold text-orange-400">Rp <?php echo e(number_format($product->total_revenue ?? 0, 0, ',', '.')); ?></p>
                        </div>
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
                    <h3 class="font-bold text-white flex items-center">
                        <i class="fas fa-tags mr-2"></i> Per Kategori
                    </h3>
                </div>
                <div class="divide-y divide-slate-700/50">
                    <?php $__empty_1 = true; $__currentLoopData = $salesByCategory ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-4 hover:bg-white/5 transition-colors">
                            <div class="flex items-center justify-between mb-2">
                                <span class="font-semibold text-white"><?php echo e($category->category_name ?? 'Tanpa Kategori'); ?></span>
                                <span class="font-bold text-blue-400">Rp <?php echo e(number_format($category->total_revenue ?? 0, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex items-center justify-between text-sm text-slate-500">
                                <span><?php echo e($category->total_sold ?? 0); ?> item terjual</span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="p-8 text-center">
        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            ...
            <div class="p-6">
                <?php if(isset($dailySales) && $dailySales->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-slate-700/50">
                                <?php $__currentLoopData = $dailySales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-white/5 transition-colors">
                                        <td class="py-3 px-4 text-slate-300">
                                            <?php echo e(\Carbon\Carbon::parse($day->date)->locale('id')->isoFormat('dddd, D MMM Y')); ?>

                                        </td>
                                        <td class="py-3 px-4 text-right">
                                            <span class="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm font-medium">
                                                <?php echo e($day->count); ?> transaksi
                                            </span>
                                        </td>
                                        <td class="py-3 px-4 text-right font-bold text-emerald-400">
                                            Rp <?php echo e(number_format($day->total, 0, ',', '.')); ?>
