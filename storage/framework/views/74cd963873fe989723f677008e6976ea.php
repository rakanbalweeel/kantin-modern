                ...
                <div class="glass-card rounded-2xl p-5 hover:bg-white/5 transition-all duration-300 group">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($stats[$key] ?? 0); ?></p>
                        </div>
            ...
            <form action="<?php echo e(route('admin.orders.index')); ?>" method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="w-48">
                    ...
                    <select name="status" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all">
                        ...
                        <option value="pending" class="bg-slate-800" <?php echo e(request('status') == 'pending' ? 'selected' : ''); ?>>Pending</option>
                        <option value="diproses" class="bg-slate-800" <?php echo e(request('status') == 'diproses' ? 'selected' : ''); ?>>Diproses</option>
                        <option value="selesai" class="bg-slate-800" <?php echo e(request('status') == 'selesai' ? 'selected' : ''); ?>>Selesai</option>
                        <option value="batal" class="bg-slate-800" <?php echo e(request('status') == 'batal' ? 'selected' : ''); ?>>Dibatalkan</option>
                    </select>
                </div>
                <div class="w-48">
                    ...
                    <tbody class="divide-y divide-slate-700/50">
                        <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl flex items-center justify-center mr-3">
                                            <span class="text-white font-bold text-sm"><?php echo e(strtoupper(substr($order->user->name ?? 'U', 0, 1))); ?></span>
                                        </div>
                                        <div>
                                            <p class="font-medium text-white"><?php echo e($order->user->name ?? 'User'); ?></p>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="px-4 py-2 bg-slate-700 text-slate-300 rounded-xl hover:bg-orange-500/20 hover:text-orange-400 transition-all inline-flex items-center">
