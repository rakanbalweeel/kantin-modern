...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <span class="text-gray-600">Halo, <?php echo e(auth()->user()->name); ?></span>
                        <?php if(auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-indigo-600 font-semibold">Dashboard Admin</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('siswa.menu')); ?>" class="text-indigo-600 font-semibold">Menu Kantin</a>
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 font-semibold">Login</a>
                ...
                <div class="text-white">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center justify-center bg-white text-indigo-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100">
                                    Masuk Dashboard Admin
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('siswa.menu')); ?>" class="inline-flex items-center justify-center bg-white text-indigo-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100">
                                    Pesan Sekarang
                                </a>
                                <a href="<?php echo e(route('siswa.orders.index')); ?>" class="inline-flex items-center justify-center border-2 border-white text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10">
                                    Lihat Pesanan Saya
                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                            
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center bg-white text-indigo-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100">
                                Daftar Sekarang
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center border-2 border-white text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition text-center">
                    <span class="text-5xl"><?php echo e($item[0]); ?></span>
                    <h3 class="text-lg font-bold text-gray-800 mt-4"><?php echo e($item[1]); ?></h3>
                    <p class="text-indigo-600 font-semibold mt-2"><?php echo e($item[2]); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="text-center mt-12">
                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-indigo-700">
    ...
    <section class="gradient-bg py-20">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-indigo-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100">
                    Daftar Sebagai Siswa
                </a>
                <a href="<?php echo e(route('login')); ?>" class="border-2 border-white text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10">
                    Login
                </a>
            </div>
        </div>
    ...
    <footer id="contact" class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> RasaPelajar. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
