...
<?php $__env->startSection('title', 'Penarikan Tunai - Kantin'); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <a href="<?php echo e(route('kantin.dashboard')); ?>" class="mt-4 md:mt-0 inline-flex items-center px-4 py-2 glass rounded-xl text-slate-300 hover:text-orange-400 hover:bg-white/10 transition-all">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-blue-400">
                    Rp <?php echo e(number_format($totalWithdrawn, 0, ',', '.')); ?>
            ...
            <div class="relative rounded-2xl p-6 overflow-hidden bg-gradient-to-br from-orange-500/20 to-amber-500/20 border border-orange-500/30">
                ...
                <div class="relative">
                    ...
                    <p class="text-2xl font-extrabold text-orange-400">
                        Rp <?php echo e(number_format($saldoTersedia, 0, ',', '.')); ?>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-yellow-400">
                    Rp <?php echo e(number_format($pendingWithdrawals, 0, ',', '.')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="glass-card rounded-2xl p-6" x-data="withdrawalForm()">
                    ...
                    <form action="<?php echo e(route('kantin.withdrawals.store')); ?>" method="POST" @submit="loading = true">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="jumlah" x-model="jumlah" @input="calculateNet()"
                                       min="10000" max="<?php echo e($saldoTersedia); ?>"
                            ...
                            <p class="mt-2 text-xs text-slate-500">
                                ...
                                Maksimal: Rp <?php echo e(number_format($saldoTersedia, 0, ',', '.')); ?>
                        ...
                        <div class="mb-6 p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                            ...
                            <div class="flex justify-between text-sm mb-2">
                                <span class="text-slate-400">Pajak (<?php echo e($pajakWithdrawal); ?>%)</span>
                        ...
                        <button type="submit" :disabled="loading || jumlah < 10000 || jumlah > <?php echo e($saldoTersedia); ?>"
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <ul class="text-sm text-blue-300/80 space-y-1">
                                <li><i class="fas fa-check mr-2 text-blue-400"></i>Pajak penarikan: <?php echo e($pajakWithdrawal); ?>%</li>
            ...
            <div class="lg:col-span-2">
                <div class="glass-card rounded-2xl overflow-hidden">
                    ...
                    <div class="divide-y divide-slate-700/50">
                        <?php $__empty_1 = true; $__currentLoopData = $withdrawalHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="p-6 hover:bg-white/5 transition-colors">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3 mb-2">
                                            <span class="font-bold text-white font-mono"><?php echo e($withdrawal->kode_withdrawal); ?></span>
                                            <?php $badge = $withdrawal->status_badge; ?>
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                                <?php if($withdrawal->status === 'pending'): ?> bg-yellow-500/20 text-yellow-400 border border-yellow-500/30
                                                <?php elseif($withdrawal->status === 'approved'): ?> bg-emerald-500/20 text-emerald-400 border border-emerald-500/30
                                                <?php else: ?> bg-red-500/20 text-red-400 border border-red-500/30
                                                <?php endif; ?>">
                                                <i class="fas <?php echo e($badge['icon']); ?> mr-1"></i>
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-3">
                                            <div>
                                                ...
                                                <p class="font-semibold text-white">Rp <?php echo e(number_format($withdrawal->jumlah, 0, ',', '.')); ?></p>
                                            </div>
                                            <div>
                                                <p class="text-slate-500">Pajak (<?php echo e($withdrawal->pajak_persen); ?>%)</p>
                                                <p class="font-semibold text-red-400">- Rp <?php echo e(number_format($withdrawal->pajak_nominal, 0, ',', '.')); ?></p>
                                            </div>
                                            <div>
                                                <p class="text-slate-500">Diterima</p>
                                                <p class="font-semibold text-emerald-400">Rp <?php echo e(number_format($withdrawal->jumlah_bersih, 0, ',', '.')); ?></p>
                                            </div>
                                            <div>
                                                <p class="text-slate-500">Metode</p>
                                                <p class="font-semibold text-white">
                                                    <?php if($withdrawal->metode_pembayaran === 'transfer'): ?>
                                                        <?php echo e($withdrawal->nama_bank); ?>
                                        ...
                                        <div class="flex items-center text-xs text-slate-500">
                                            ...
                                            <?php echo e($withdrawal->created_at->locale('id')->isoFormat('D MMM Y, HH:mm')); ?>

                                            <?php if($withdrawal->approved_at && $withdrawal->approver): ?>
                                                <span class="mx-2">•</span>
                                                <span><?php echo e($withdrawal->status === 'approved' ? 'Disetujui' : 'Ditolak'); ?> oleh <?php echo e($withdrawal->approver->name); ?></span>
                                            <?php endif; ?>
                                        </div>

                                        <?php if($withdrawal->catatan): ?>
                                            <div class="mt-2 p-2 bg-slate-800/50 rounded-lg text-sm text-slate-400 border border-slate-700">
                                                <i class="fas fa-comment mr-1"></i> <?php echo e($withdrawal->catatan); ?>
                    ...
                    <?php if($withdrawalHistory->hasPages()): ?>
                        <div class="px-6 py-4 border-t border-slate-700">
                            <?php echo e($withdrawalHistory->links()); ?>
...
function withdrawalForm() {
    return {
        jumlah: '',
        metode: 'transfer',
        pajakPersen: <?php echo e($pajakWithdrawal); ?>,
        pajakNominal: 0,
        jumlahBersih: 0,
        loading: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kantin-modern\resources\views/kantin/withdrawals/index.blade.php ENDPATH**/ ?>