        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div class="glass-card rounded-xl p-4 hover:bg-white/5 transition-all">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-white"><?php echo e($categories->total()); ?></p>
            ...
            <div class="glass-card rounded-xl p-4 hover:bg-white/5 transition-all">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-white"><?php echo e($categories->sum(fn($c) => $c->products_count ?? $c->products->count())); ?></p>
            ...
            <div class="glass-card rounded-xl p-4 hover:bg-white/5 transition-all">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        ?>
                        <p class="text-sm font-bold text-white truncate"><?php echo e($topCategory?->nama ?? '-'); ?></p>
            ...
            <div class="glass-card rounded-xl p-4 hover:bg-white/5 transition-all">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-white"><?php echo e($categories->count() > 0 ? round($categories->sum(fn($c) => $c->products_count ?? $c->products->count()) / $categories->count(), 1) : 0); ?></p>
                            ...
                            <tr class="group hover:bg-white/5 transition-colors duration-200">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="font-bold text-white group-hover:text-orange-400 transition-colors"><?php echo e($category->nama); ?></p>
                                            <p class="text-xs text-slate-500">ID: <?php echo e($category->id); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-5">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap text-center">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold <?php echo e($productCount > 0 ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20' : 'bg-slate-700 text-slate-400'); ?>">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="<?php echo e(route('admin.categories.destroy', $category)); ?>" 
                                              method="POST" 
                                              class="inline"
                                              onsubmit="return confirm('Yakin ingin menghapus kategori <?php echo e($category->nama); ?>?')">
                                            <?php echo csrf_field(); ?>
