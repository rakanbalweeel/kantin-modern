                ...
                <div class="glass rounded-2xl p-4 mb-8">
                    <div class="flex flex-wrap gap-3">
                        <a href="<?php echo e(route('siswa.menu')); ?>" 
                           class="px-5 py-2.5 rounded-xl font-medium transition-all duration-300 <?php echo e(!request('category') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/30' : 'bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white'); ?>">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="<?php echo e(route('siswa.menu', ['category' => $category->id])); ?>" 
                               class="px-5 py-2.5 rounded-xl font-medium transition-all duration-300 <?php echo e(request('category') == $category->id ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/30' : 'bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white'); ?>">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="group glass-card rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-orange-500/10 hover:-translate-y-2 transition-all duration-500">
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                <div class="absolute top-3 left-3">
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold glass text-white">
                                        <i class="fas fa-tag mr-1.5 text-orange-400"></i><?php echo e($product->category->nama); ?>
                            ...
                            <div class="p-5">
                                <h3 class="font-bold text-white text-lg mb-2 group-hover:text-orange-400 transition-colors"><?php echo e($product->nama); ?></h3>
            ...
            <div class="relative glass-card rounded-3xl shadow-2xl max-w-md w-full overflow-hidden"
                ...
                <form action="<?php echo e(route('siswa.saldo.topup')); ?>" method="POST" class="p-6">
                    ...
                    <div class="glass rounded-2xl p-4 mb-6">
                        ...
                        <p class="text-2xl font-bold text-white">Rp <?php echo e(number_format(auth()->user()->saldo ?? 0, 0, ',', '.')); ?></p>
                    </div>
