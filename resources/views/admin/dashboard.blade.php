    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-slate-400 text-lg">Selamat datang kembali, <span class="font-semibold text-white">{{ auth()->user()->name }}</span>! 👋</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-blue-400">{{ $stats['pesanan_hari_ini'] ?? 0 }}</p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-purple-400">{{ $stats['total_produk'] ?? 0 }}</p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-6 hover:bg-white/5 transition-all duration-300">
                ...
                <p class="text-2xl font-extrabold text-orange-400">{{ $stats['total_siswa'] ?? 0 }}</p>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-6 mb-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.products.index') }}" class="glass rounded-xl p-4 text-center hover:bg-white/10 transition-all group">
                ...
                <a href="{{ route('admin.categories.index') }}" class="glass rounded-xl p-4 text-center hover:bg-white/10 transition-all group">
                ...
                <a href="{{ route('admin.orders.index') }}" class="glass rounded-xl p-4 text-center hover:bg-white/10 transition-all group">
                ...
                <a href="{{ route('admin.reports.sales') }}" class="glass rounded-xl p-4 text-center hover:bg-white/10 transition-all group">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-orange-500 to-amber-500 px-6 py-4 flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="text-white/80 hover:text-white text-sm">
                        ...
                        <div class="p-4 hover:bg-white/5 transition-colors">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-semibold text-white">{{ $order->kode_pesanan }}</p>
                                ...
                                <div class="text-right">
                                    ...
                                    <span class="px-2 py-1 {{ $statusColors[$order->status] ?? $statusColors['pending'] }} rounded-lg text-xs font-medium">
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-red-500 to-pink-600 px-6 py-4 flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="text-white/80 hover:text-white text-sm">
                        Lihat Semua <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                <div class="divide-y divide-slate-700/50">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-500">{{ $product->category->nama ?? 'No Category' }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
