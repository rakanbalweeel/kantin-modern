...
<div class="min-h-screen hero-gradient py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-4 text-2xl font-bold text-white">Edit <span class="gradient-text">Kategori</span></h1>
            <p class="mt-1 text-slate-400">Perbarui informasi kategori {{ $category->nama }}</p>
        </div>
