    ...
    <div class="hero-gradient min-h-screen flex items-center justify-center relative grid-pattern" x-data="loginForm()">
        ...
        <div class="max-w-md w-full mx-4 relative z-10">
            ...
            <div class="glass-card rounded-3xl p-8 sm:p-10">
                ...
                {{-- Form Login --}}
                <form id="login-form" action="{{ route('login') }}" method="POST" class="space-y-6" @submit="loading = true">
                    @csrf
                ...
                <div class="mt-8 text-center">
                    <p class="text-slate-400">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold gradient-text hover:underline">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
