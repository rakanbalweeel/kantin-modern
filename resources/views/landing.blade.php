            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        @auth
                            <span class="text-slate-400">Halo, {{ auth()->user()->name }}</span>
                            @if(auth()->user()->isAdmin())
                                <a href="{{ route('admin.dashboard') }}" class="text-orange-500 font-semibold hover:text-orange-400">Dashboard</a>
                            @else
                                <a href="{{ route('siswa.menu') }}" class="text-orange-500 font-semibold hover:text-orange-400">Menu</a>
                            @endif
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-white font-semibold hover:text-orange-400 transition">Login</a>
                            <a href="{{ route('register') }}" class="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-2.5 rounded-xl font-semibold hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:-translate-y-0.5">
                                Daftar
                            </a>
                        @endauth
                    </div>
                ...
                <div x-show="mobileOpen" x-transition class="md:hidden pb-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        @guest
                            ...
                            <a href="{{ route('register') }}" class="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-2.5 rounded-xl font-semibold text-center">Daftar</a>
                        @endguest
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        @auth
                            @if(auth()->user()->isAdmin())
                                <a href="{{ route('admin.dashboard') }}" class="btn-glow inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300">
                            ...
                            @else
                                <a href="{{ route('siswa.menu') }}" class="btn-glow inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                                    Pesan Sekarang
                                </a>
                                <a href="{{ route('siswa.orders.index') }}" class="inline-flex items-center justify-center glass text-white font-bold px-8 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            @endif
                        @else
                            <a href="{{ route('register') }}" class="btn-glow inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                </svg>
                                Daftar Gratis
                            </a>
                            <a href="{{ route('login') }}" class="inline-flex items-center justify-center glass text-white font-bold px-8 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div class="menu-card glass-card rounded-3xl p-6 text-center group cursor-pointer">
                    <div class="w-20 h-20 bg-gradient-to-br {{ $item[4] }} rounded-2xl flex items-center justify-center mx-auto mb-4 {{ $item[5] }} border">
                        <span class="text-4xl">{{ $item[0] }}</span>
                    </div>
                    <h3 class="text-lg font-bold text-white mb-1">{{ $item[1] }}</h3>
                    <p class="text-xs text-slate-500 mb-3">{{ $item[3] }}</p>
                    <p class="text-orange-500 font-bold text-lg">{{ $item[2] }}</p>
                </div>
                @endforeach
            </div>
            
            <div class="text-center mt-12">
                <a href="{{ route('register') }}" class="btn-glow inline-flex items-center bg-gradient-to-r from-orange-500 to-amber-500 text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300">
                    Lihat Semua Menu
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="glass-card rounded-3xl p-8">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h4 class="font-bold text-white">{{ $testimonial[0] }}</h4>
                            <p class="text-sm text-slate-500">{{ $testimonial[1] }}</p>
                        </div>
                    </div>
                    <p class="text-slate-400 italic">"{{ $testimonial[2] }}"</p>
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            <div class="glass-card rounded-3xl p-12 border border-orange-500/20">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('register') }}" class="btn-glow bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-10 py-4 rounded-2xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300 inline-flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                        Daftar Sekarang
                    </a>
                    <a href="{{ route('login') }}" class="glass text-white font-bold px-10 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300 inline-flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                        </svg>
                        Login
    ...
    <footer id="contact" class="bg-slate-900 border-t border-slate-800 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-slate-500 text-sm">&copy; {{ date('Y') }} RasaPelajar. All rights reserved.</p>
